...
type MessageToAllClients struct {
	...
	Games      []*tarabish.Game `json:"games"`
...
type MessageToOnePlayer struct {
	...
	TsSent             string                             `json:"tsSent"`
	PlayerName         string                             `json:"playerName"`
	HandPlayerView     tarabish.HandPlayerView            `json:"handPlayerView,omitempty"`
	AllHandPlayerViews map[string]tarabish.HandPlayerView `json:"allHandPlayerViews,omitempty"`
	...
	FinalTableTake     tarabish.FinalTableTake            `json:"finalTableTake"`
	MsgVersion         string                             `json:"msgVersion"`
}
