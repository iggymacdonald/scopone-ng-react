...
func sendPlayerViews(c *client, handViewForPlayers map[string]tarabish.HandPlayerView, responseTo string) {
...
func sendObserverUpdates(c *client, handViewForPlayers map[string]tarabish.HandPlayerView, responseTo string, game *tarabish.Game) {
...
func sendCardsPlayedAndTaken(c *client, cardPlayed deck.Card, cardsTaken []deck.Card,
	finalTableTake tarabish.FinalTableTake, game *tarabish.Game, responseTo string) {
